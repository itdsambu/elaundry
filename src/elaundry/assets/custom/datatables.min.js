 ...
 *   https://datatables.net/download/#bs/dt-1.13.3/date-1.3.1/fc-4.2.1/fh-3.3.1/kt-2.8.1/r-2.4.0/sc-2.1.0/sb-1.4.0/sp-2.1.1/sl-1.6.1
 *
 * Included libraries:
 *   DataTables 1.13.3, DateTime 1.3.1, FixedColumns 4.2.1, FixedHeader 3.3.1, KeyTable 2.8.1, Responsive 2.4.0, Scroller 2.1.0, SearchBuilder 1.4.0, SearchPanes 2.1.1, Select 1.6.1
 */
			...
			(C.ext = p =
				{
					...
					classes: {},
					build:
						"bs/dt-1.13.3/date-1.3.1/fc-4.2.1/fh-3.3.1/kt-2.8.1/r-2.4.0/sc-2.1.0/sb-1.4.0/sp-2.1.1/sl-1.6.1",
					errMode: "alert",
					feature: [],
					search: [],
					...
					if (((t = a[i]), Array.isArray(t))) c(e, t);
						...
						switch (((f = p = ""), t)) {
							...
							case "previous":
								...
								break;
							case "next":
								(p = m.sNext), (f = t + (l < u - 1 ? "" : " disabled"));
								break;
							case "last":
								(p = m.sLast), (f = t + (l < u - 1 ? "" : " disabled"));
								break;
							default:
								(p = t + 1), (f = l === t ? "active" : "");
						}
...
!(function (n) {
	"function" == typeof define && define.amd
		? define(
				["jquery", "datatables.net-bs", "datatables.net-searchbuilder"],
				function (e) {
					return n(e, window, document);
				}
		  )
				...
				return (
					...
					(t =
						...
						("undefined" != typeof window
							? require("jquery")
							: require("jquery")(e))).fn.dataTable ||
						require("datatables.net-bs")(e, t),
					t.fn.dataTable || require("datatables.net-searchbuilder")(e, t),
					n(t, 0, e.document)
				);
		  })
		: n(jQuery, window, document);
...
!(function (e) {
	...
	function E(s, e, t) {
		var a = i.extend(
			...
			a = new (
				a && (a.cascadePanes || a.viewTotal) ? B.SearchPanesST : B.SearchPanes
			)(s, a);
		s
			.button(e)
...
!(function (n) {
	"function" == typeof define && define.amd
		? define(
				["jquery", "datatables.net-bs", "datatables.net-searchpanes"],
				function (e) {
					return n(e, window, document);
				}
		  )
