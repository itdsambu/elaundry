<table class="table table-bordered table-hover table-striped" width="100%">
    <thead>
        ...
        <tr>
           ...
           <th>Tanggal : <?php echo $tanggalAwal?> s/d <?php echo $tanggalAkhir?> <br><br></th>
        </tr>
        <!-- <tr>
...
<table class="table table-bordered table-hover table-striped" border="1">
    ...
    <tbody>
        ...
        <tr style="height: 50px;">
            ...
            <!-- <td class="text-center">
                <a class="btn btn-sm purple" onclick="detail(this.id)" id="<?php echo $get->Tgl_transaksi?>">
                    <i class="fa fa-eye"></i>
                    Detail
                </a>
            </td> -->
    ...
    <?php
        ...
        <tr style="height: 50px;">
            ...
            <td class="text-center"></td>
            <td class="text-center"></td>
            <td class="text-center"><strong><?php echo number_format($gt->GrandTotal,2,',','.');?></strong></td>
            <td class="text-center"></td>
...
<div class="text-left">
    <a target="blank" href="<?php echo base_url('MonitoringRekapPembelian/ExportExcelRekapPerhari/'.$tanggalAwal.'/'.$tanggalAkhir);?>" class="btn green-seagreen">
        <i class="fa fa-file-excel-o"></i>
        Export Excel
    </a>
    <a target="blank" href="<?php echo base_url('MonitoringRekapPembelian/ExportPdfRekapPerhari/'.$tanggalAwal.'/'.$tanggalAkhir);?>" class="btn blue">
