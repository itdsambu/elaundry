...
class PDF extends FPDF {
        function Header(){
          ...
          $this->Cell(190,5,'PT RIAU SAKTI UNITED PLANTATIONS',0,0,'C');
          $this->Cell(10,8,'Dept',0,0,'L');
          $this->Cell(40,8,': SKT',0,0,'L');
          $this->SetXY(47,$this->GetY()+10);
          $this->Line(235, $this->GetY(), 280, $this->GetY());
          $this->SetFont('Times','B',12);
          $this->Cell(190,10,'LAPORAN REKAP BELANJA DAPUR MESS MANAGER',0,0,'C');
...
$this->Ln(10);
    ...
    $yawal = $pdf->GetY();
      foreach($getData as $get){
        ...
        $pdf->SetXY(185,$y);
    if($get->kategoriID == 18){
        $pdf->MultiCell(25,3,number_format($get->Total,2),0,'R');
        $pdf->SetXY(210,$y);
    }else{
        $pdf->MultiCell(25,3,'',0,'R');
        $pdf->SetXY(210,$y);
