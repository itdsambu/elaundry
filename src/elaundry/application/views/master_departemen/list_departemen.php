            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption font-dark">
                        ...
                        <span class="caption-subject bold uppercase"> Master Departemen</span>
                    </div>
                    <div class="tools">
                ...
                <div class="portlet-body">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="btn-group pull-right">
                                    <a href="<?php echo site_url('Departemen/tambah') ?>" class="btn green">
                    ...
                    <table class="table table-striped table-bordered table-hover table-header-fixed" id="table">
                        ...
                        <tbody>
                            <?php foreach ($listdept as $get) {

                            ?>
                                <tr>
                                    <td><?php echo $get->divisi ?></td>
                                    <td class="text-center"><?php echo $get->deptabbr ?></td>
                                    <td><?php echo $get->deptname ?></td>
                                    <!-- <td class="text-center" <?php echo $color ?>>
                                        <?php // echo $inactive 
                                        ?>
                                    </td> -->
                                    <!-- <td><?php // if ($get->createdate != NULL) { echo date('d M Y', strtotime($get->createdate)); /} 
                                                ?></td>
                                    <td><?php // if ($get->updatedate != NULL) { echo date('d M Y', strtotime($get->updatedate)); } 
                                        ?></td> -->
                                    <!-- <td class="text-center">
                                        <a href="<?php echo site_url('Departemen/edit/' . $get->deptid) ?>" class="btn btn-icon-only blue" title="Edit"><i class="fa fa-edit"></i></a>
