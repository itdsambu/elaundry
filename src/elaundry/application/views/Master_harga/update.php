                        ...
                        <div class="portlet light">
                            <div class="portlet-body">
                                <div class="scroller" style="height:auto;" data-rail-visible="1" data-rail-color="yellow" data-handle-color="#a1b2bd">
                                   <div class="col-md-12">
                                        <legend>Edit Master Harga</legend>
                                            <form class="form-horizontal" action="<?php echo base_url('Master_harga/updateData') ?>" method="post" entype="multipart/form-data">
                                            <?php foreach($getDataHeader as $hdr){?>
                                              ...
                                              <div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-lg-4">
                                                       <input name="tanggal" id="tanggal" class="form-control" readonly="readonly" value="<?php echo date('Y-m-d',strtotime($hdr->tanggal))?>">
                                                    </div>
                                                </div>
                                              <?php }?>
                                                <br>
                                                ...
                                                <div class="row">
                                                    <div class="form-group">
                                                        ...
                                                        <table class="table table-bordered table-hover" id="dataTable">
                                                            ...
                                                            <tbody>
                                                              <?php foreach($getDataDetail as $dtl){?>
                                                              <tr>
                                                                ...
                                                                <td>
                                                                    <select class="form-control txt" name="txtNamaItem[]" id="itemid1">
                                                                        <option>-- Pilih --</option>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <option>-- Pilih --</option>
                                                                            <?php foreach($dataKategori as $ktg){
                                                                              if($dtl->kategoriID == $ktg->kategoriID){?>
                                                                                <option value="<?php echo $ktg->kategoriID?>" selected><?php echo $ktg->nama_kategori?></option>
                                                                            <?php }else{?>
                                                                ...
                                                                <td>
                                                                   <input name="txtHarga[]" id="harga" class="form-control" placeholder="Harga" value="<?php echo $dtl->harga?>" onkeypress="return hanyaAngka(event)" readonly>
                                                                </td>
                                                                <td>
          ...
          $('table[id="dataTable"]').append('<tbody">\n\
            <tr>\n\
              ...
              <td class="text-center txt">\n\
                  <select id="namaitem'+l+'" name="txtNamaItem[]" class="form-control txt" >\n\
                  <option>--Pilih--</option>\n\
                   <?php foreach($dataItem as $itm){?>
                      <option value="<?php echo $itm->itemID?>"><?php echo $itm->nama_item?></option>\n\
                    <?php } ?>
              ...
              <td class="text-center">\n\
                   <input name="txtHarga[]" id="harga" class="form-control" placeholder="Harga" onkeypress="return hanyaAngka(event)">\n\
              </td>\n\
              <td>\n\
