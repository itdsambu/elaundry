        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="portlet light bordered">
                <?php foreach ($getDataHdr as $hdr) {
                    ...
                    <div class="row">
                        <input type="hidden" name="headerid" id="headerid" value="<?= $hdrid ?>">
                        <div class="col-lg-8 col-md-8 col-sm-10 col-xs-12" style="padding:0;">
                            ...
                            <?php if ($laundry_stat != 1) { ?>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                    <label class="control-label">: <?php if ($hdr->SelesaiDate != '') { echo date('d-m-Y', strtotime($hdr->SelesaiDate)); } ?></label>
                                </div>
                                <?php 
                            } ?>
                            ...
                            <?php if ($laundry_stat == 3) { ?>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                    <label class="control-label">: <?php if ($hdr->DiambilDate != '') { echo date('d-m-Y', strtotime($hdr->DiambilDate)); } ?></label>
                                </div>
