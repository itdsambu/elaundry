                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-1">
                                            <button type="button" class="form-control cari_NIK btn-primary" id="cari_NIK">Cari</button>
                                        </div>
                                    </div>
                                    <div class="form-group">
...
<script type="text/javascript">
    ...
    // Setting DOM
    const btnAdd        = document.querySelector("button#tambah");
    const btnSearch     = document.querySelector("button#cari_NIK");
    const posLaundry    = document.querySelector("select#pos_ldy");
    const StatusTK      = document.querySelector("input.StatusTK");

    // Manipulations
    btnAdd.setAttribute("disabled", "");
    btnSearch.setAttribute("disabled", "");
    btnSearch.style.color = '#333';

    posLaundry.addEventListener('change', function () {
        const dt_tanggal_terima = $('.TanggalTerima').val();
        const data = dt_tanggal_terima.split('-');
        const tahun = data[0];
        const bulan = data[1];
        const pos_ldy = $('#pos_ldy').val();
    ...
    StatusTK.addEventListener('change', function () {
        const cekTk     = $("input[type='radio']:checked").length;
        const pos_ldy   = $('#pos_ldy').val();
    ...
    function pilih(sel) {
        let id            = $(sel).attr('id');
        let nama          = $(sel).closest('tr').find('.nama').text();
        let nik           = $(sel).closest('tr').find('.nik').text();
        let telegramid    = $(sel).closest('tr').find('.telegramid').text();
        let dept          = $(sel).closest('tr').find('.bagian_abbr').text();
        let cv            = $(sel).closest('tr').find('.personalstatus').text();
