        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <?php foreach ($getDataHdr as $hdr) {
                    ...
                    <div class="row">
                        <div class="col-lg-8 col-md-8 col-sm-10 col-xs-12" style="padding:0;">
                            <label class="col-lg-6 col-md-6 col-sm-6 col-xs-6"><b>Alamat Laundry</b></label>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                <label class="control-label">: <?php echo number_format($hdr->TotalTagihan, 0, ',', '.') ?></label>
                            </div>
                            <label class="col-lg-6 col-md-6 col-sm-6 col-xs-6"><b>Diantar Oleh :</b></label>
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                <label class="control-label">: <?= $hdr->diantar_oleh; ?></label>
                            </div>
                            ...
                            <?php if ($laundry_stat == 3) { ?>
                                ...
                                <label class="col-lg-6 col-md-6 col-sm-6 col-xs-6"><b>Foto Pengambil</b></label>
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                    <?php if ($hdr->link_upload_pengambil != '') { ?>
                                        <img src="<?php echo base_url() ?><?php echo $hdr->link_upload_pengambil . $hdr->ID ?>.jpg" width="150px" alt="Maaf File Tidak Ada ..!!">
                                    <?php } else { ?>
                                        <b>Tidak ada</b>
                                    <?php } ?>
                                </div>
            ...
            <div class="portlet light bordered">
                            ...
                            foreach ($getDataLaundry as $dtl) { ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <img src="<?php echo base_url() ?><?php echo $dtl->link_upload_itemdetail . $dtl->header_id . '_' . $dtl->detail_id ?>.jpg" width="125px" alt="Maaf File Tidak Ada ..!!">
                                    </td>
                                    <?php if ($laundry_stat == 3) { ?>
                ...
                <div class="col text-center">
                    <?php if ($laundry_stat == 1) { ?>
                        <a class="btn btn-warning" id="<?php echo $hdrid ?>" onclick="testing(this, 'status_laundry');">
                            Update Selesai Dikerjakan
                        </a>
                    <?php } ?>
                </div>
            </div>
...
<script type="text/javascript">
    function testing(upd, status_laundry) {
        var status = $('.' + status_laundry).text();
        var id = $(upd).attr('id');
        if (status == 'SEDANG DIPROSES') {
            $.post("<?php echo site_url(); ?>Penerimaan_laundry/updateSelesai?id=" + id, function(data) {
                alert(data);
                location.reload();
            });
        } else if (status == 'SELESAI DIKERJAKAN') {
            $.post("<?php echo site_url(); ?>Pengambilan_laundry/updateDiambil?id=" + id, function(data) {
                alert(data);
                location.reload();
            });
        }
