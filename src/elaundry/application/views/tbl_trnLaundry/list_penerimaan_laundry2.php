                        ...
                        <thead>
                            <tr 
                                ...
                                <?php if ($status_laundry == 1) {
                                    ...
                                    if ($this->session->userdata('group_user') == 1 || $this->session->userdata('group_user') == 166 && $this->session->userdata('jabatan') == 17) {
                                        echo '<th class="text-center" rowspan="1" colspan="2">Aksi</th>';
                                    } else {
                                ...
                                foreach ($getDataHeader as $get) {
                                    ...
                                    <tr <?php $background ?>>
                                        ...
                                        <?php if ($status_laundry == 1) { ?>
                                            ...
                                            <?php if ($this->session->userdata('group_user') == 1 || $this->session->userdata('group_user') == 166 && $this->session->userdata('jabatan') == 17) { ?>
                                                <td class="text-center">
