                            ...
                            if (count($getDataHeader) > 0) {
                                foreach ($getDataHeader as $get) {
                                    ...
                                    if ($get->IDStatusPelayanan == 1 && $lebih == TRUE) {
                                        echo '<tr style="background-color : #FCE1DF;">';
                                    } else {
                                        echo '<tr>';
                                    } ?>
                                    <!-- <tr> -->
                                    ...
                                    <td class="text-center">
                                        <?php foreach ($get_MstStatusLaundry as $row3) {
                                            if ($get->IDStatusPelayanan == $row3->IDStatusPelayanan && $get->IDStatusPelayanan == 1) {
                                                echo '<span class="label label-sm label-danger">' . $row3->StatusPelayanan . '</span>';
                                            } elseif ($get->IDStatusPelayanan == $row3->IDStatusPelayanan && $get->IDStatusPelayanan == 2) {
                                                echo '<span class="label label-sm label-warning">' . $row3->StatusPelayanan . '</span>';
                                            } elseif ($get->IDStatusPelayanan == $row3->IDStatusPelayanan && $get->IDStatusPelayanan == 3) {
                                                echo '<span class="label label-sm label-success">' . $row3->StatusPelayanan . '</span>';
                                    ...
                                    <?php if ($status_laundry == 1) { ?>
                                        <td class="text-center">
                                            <?php if ($get->IDStatusPelayanan == 1) { ?>
                                                ...
                                                <!-- <a class="btn btn-circle btn-icon-only btn-primary" href="<?php //echo site_url('Penerimaan_laundry/ModalDetailItemGet/' . $get->ID); 
                                                                                                                ?>"><i class="fa fa-eye"></i></a> -->
                                            <?php } else if ($get->IDStatusPelayanan == 2 || $get->IDStatusPelayanan == 4) { ?>
                                            ...
                                            <?php } else if ($get->IDStatusPelayanan == 3) { ?>
