            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption font-dark">
                        ...
                        <span class="caption-subject bold uppercase">Approve Nota Perjalanan Dinas - KD SKT</span>
                    </div>
                    <div class="tools">
                ...
                <div class="portlet-body">
                    <form class="form-horizontal" role="form" method="post" action="<?php echo base_url('ApproveNota/approveDataKadept')?>">
                        <div class="form-body">
                            <div class="row">
                                <div class="col-lg-12">
