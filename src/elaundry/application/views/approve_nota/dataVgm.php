            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption font-dark">
                        ...
                        <span class="caption-subject bold uppercase">Approve Nota Perjalanan Dinas (VGM)</span>
                    </div>
                    <div class="tools">
                    ...
                    <div class="portlet-body">
                        ...
                        <?php if($this->input->get('msg') == "success"){
                            ...
                            echo "<strong>Sukses !!!</strong> Data berhasil di Approve.";
                            echo "</div>";
                        }elseif($this->input->get('msg') == "failed"){
                            echo "<div class='alert alert-danger'>";
                            echo "<strong>Gagal !!!</strong> Data tidak dapat di Approve.";
                            echo "</div>";
                        } ?>
                    </div>
                </div>
                <div class="portlet-body">
                    <form class="form-horizontal" role="form" method="post" action="<?php echo base_url('ApproveNota/approveDataVgm')?>">
                        <div class="form-body">
                            <div class="row">
                                <div class="col-lg-12">
                                    <table  class="table table-striped table-bordered table-hover table-header-fixed" id="table">
                                        <thead>
                                            <tr>
                                                <th width="3%" class="text-center" rowspan="2">
                                            ...
                                            <tr>
                                                <th class="text-center">Kasi</th>
                                                <th class="text-center">KD SKT</th>
                                        ...
                                        <tbody>
                                            <?php foreach($getData as $get){?>
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <?php if($get->Approve1 == 1){
                                                            echo '<label style="background-color:#2dce44;"><strong>Approved</strong></label>';
                                                        }else{
                                                            echo '<label style="background-color:#f30000;"><strong>Pending</strong></label>';
                                                        }?>
                                                    </td>
                                                    <td class="text-center">
                                                        <?php if($get->Approve2 == 1){
                                                            echo '<label style="background-color:#2dce44;"><strong>Approved</strong></label>';
                                                        }else{
                                                            echo '<label style="background-color:#f30000;"><strong>Pending<strong></label>';
                                                        }?>
