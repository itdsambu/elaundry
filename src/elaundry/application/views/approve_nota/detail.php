        ...
        <th>
           <div class="form-group" width="15%">
               ...
               <label class="col-lg-8 control-label">:
                <?php  foreach($getDataNotaHdr as $tgl){
                    echo date('d-M-Y',strtotime($tgl->TanggalNota));
                }?>
               </label>
           </div>
        </th>
            ...
            <th>
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label class="col-lg-5 control-label">NO.LPPT </label>
                                <label class="col-lg-7 control-label"> : <?php echo $get->NoLppt?></label>
                            </div>
                            <br>
                            <div class="form-group">
                                <label class="col-lg-5 control-label">Nama Operator </label>
                                <label class="col-lg-7 control-label"> : <?php echo $get->Nama_sopir?></label>
                            </div>
                            <br>
                            <div class="form-group">
                                <label class="col-lg-5 control-label">Tanggal Berangkat </label>
                                <label class="col-lg-7 control-label"> <?php foreach($getDtlPerjalanan as $dtpr) { ?> : <?php if($dtpr->Tgl_berangkat != '') { 
                                        echo date('d-M-Y',strtotime($dtpr->Tgl_berangkat));
                                    }else{
                                        echo ''; } } ?></label>
                            </div>
                            <br>
                            <div class="form-group">
                                ...
                                <label class="col-lg-7 control-label"><?php foreach($getDtlPerjalanan as $dtpr) { ?> : <?php echo $dtpr->Keperluan?><?php } ?></label>
                            </div>
                            <br>
                            <div class="form-group">
                                <label class="col-lg-5 control-label">Jam </label>
                            
                                <label class="col-lg-7 control-label"><?php foreach($getDtlPerjalanan as $dtpr) { ?> : <?php echo date('H:i',strtotime($dtpr->Jam))?><?php } ?></label>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label class="col-lg-5 control-label">Speedboat </label>
                            ...
                            <div class="form-group">
                                ...
                                <label class="col-lg-7 control-label"><?php foreach($getDtlPerjalanan as $dtpr) { ?> : <?php if($dtpr->Tgl_kembali != '') {
                                        echo date('d-M-Y',strtotime($dtpr->Tgl_kembali));
                                    }else{
                                        echo '';} } ?></label>
                            </div>
                        </div>
