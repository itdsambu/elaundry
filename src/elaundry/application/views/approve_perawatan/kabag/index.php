        ...
        <div class="col-lg-12">
            ...
            <div class="portlet light bordered">
                ...
                <div class="portlet-body">
                    <form class="form-horizontal" role="form" method="post" action="<?php echo base_url('Approve_perawatan/approveKabag')?>">
                        <div class="form-body">
                            <div class="row">
                                <div class="col-lg-12">
...
<script type="text/javascript">
    function tolak(clicked_id){
        $.post("<?php echo site_url();?>Approve_perawatan/modalTolakKabag?id="+clicked_id, function (data){
            $('#tolak').html(data);
        });
