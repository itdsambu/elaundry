            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption font-dark">
                        ...
                        <span class="caption-subject bold uppercase">Data Approval Pembelian / Perawatan</span>
                    </div>
                    <div class="tools">
                ...
                <div class="portlet-body">
                    <form class="form-horizontal" role="form" method="post" action="<?php echo base_url('Approval/approveKabag')?>">
                        <div class="form-body">
                            <div class="row">
                                <div class="col-lg-12">
...
<script type="text/javascript">
    function tolak(clicked_id){
        $.post("<?php echo site_url();?>Approval/modalTolak?id="+clicked_id, function (data){
            $('#tolak').html(data);
        });
...
<script type="text/javascript">
    function view(clicked_id){
        // alert(clicked_id);
        $.post("<?php echo site_url();?>Approval/viewFile?id="+clicked_id, function (data){
            $('#view').html(data);
        });
