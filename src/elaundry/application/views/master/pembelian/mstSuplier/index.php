                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="btn-group pull-right">
                                    <a href="<?php echo site_url('Suplier/input') ?>" class="btn green">
                            ...
                            <?php foreach($getData as $get): ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="<?php echo site_url('Suplier/update')."/".$get->SuplierID; ?>" class="btn btn-icon-only blue" title="Edit"><i class="fa fa-edit"></i></a>
                                        <a href="<?php echo site_url('Suplier/delete')."/".$get->SuplierID; ?>" class="btn btn-icon-only red" title="Hapus" onClick="return confirm('Hapus <?php echo $get->Nama_suplier;?> ?')"><i class="fa fa-trash"></i></a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
