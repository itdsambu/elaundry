                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="btn-group pull-right">
                                    <a href="<?php echo site_url('Kategori/input') ?>" class="btn green">
                    ...
                    <table class="table table-striped table-bordered table-hover table-header-fixed" id="table">
                        ...
                        <tbody>
                            <?php foreach($getData as $get): ?>
                                <tr>
                                    <td><?php echo $get->Kategori ?></td>
                                    <td><?php if($get->InActive == 1){echo 'Aktif';}else{echo 'Tidak Aktif';} ?></td>
                                    ...
                                    <td class="text-center">
                                        <a href="<?php echo site_url('Kategori/update')."/".$get->KategoriID; ?>" class="btn btn-icon-only blue" title="Edit"><i class="fa fa-edit"></i></a>
                                        <a href="<?php echo site_url('Kategori/delete')."/".$get->KategoriID; ?>" class="btn btn-icon-only red" title="Hapus" onClick="return confirm('Hapus <?php echo $get->Kategori;?> ?')"><i class="fa fa-trash"></i></a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
