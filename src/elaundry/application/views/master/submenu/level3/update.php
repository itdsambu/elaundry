            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption font-dark">
                        ...
                        <span class="caption-subject bold uppercase"> Menu Level 3</span>
                    </div>
                    <div class="tools">
                ...
                <div class="portlet-body">
                    <?php foreach($getUser as $set): ?>
                        <form class="form-horizontal" role="form" method="post" action="<?php echo site_url('Level3/saveupdate') ?>">
                            <div class="form-body">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-5">
                                                <select class="form-control select2" id="MenuHeader" name="MenuHeader">
                                                    <?php foreach($getMenu2 as $get){
                                                        if($set->MenuHeader == $get->MenuID){
                                                            echo "<option value=".$get->MenuID." selected>".$get->MenuID." - ".$get->MenuLabel."</option>";
                                                        }else{
                                                            echo "<option value=".$get->MenuID.">".$get->MenuID." - ".$get->MenuLabel."</option>";
                                                        }
                                                    } ?>
                                                </select>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-5">
                                                <input type="text" class="form-control" id="MenuLabel" name="MenuLink" value="<?php echo $set->MenuLink?>">
                                            </div>
                                        </div>
                                    </div>
                                </div>
