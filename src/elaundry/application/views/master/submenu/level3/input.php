        ...
        <div class="col-lg-12">
            ...
            <div class="portlet light bordered">
                ...
                <div class="portlet-body">
                    <form class="form-horizontal" role="form" method="post" action="<?php echo site_url('Level3/save') ?>">
                        <div class="form-body">
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-5">
                                            <textarea class="form-control" rows="2" id="MenuIcon" name="MenuIcon"><i class="fa fa-angle-right"></i></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
