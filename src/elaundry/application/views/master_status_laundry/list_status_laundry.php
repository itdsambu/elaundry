            ...
            <div class="portlet light bordered">
                ...
                <div class="portlet-body">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="btn-group pull-right">
                                    <a href="<?php echo site_url('Master_status_laundry/tambah') ?>" class="btn green">
                    ...
                    <table class="table table-striped table-bordered table-hover table-header-fixed" id="table">
                        ...
                        <tbody>
                            <?php foreach($listmasterstatus as $get): ?>
                                <tr>
                                    <td><?=$get->StatusPelayanan?></td>
                                    ...
                                    <td class="text-center">
                                        <a href="<?php echo site_url('Master_status_laundry/edit')."/".$get->IDStatusPelayanan; ?>" class="btn btn-icon-only blue" title="Edit"><i class="fa fa-edit"></i></a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
