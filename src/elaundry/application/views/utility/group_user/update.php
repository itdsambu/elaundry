            ...
            <div class="portlet light bordered">
                ...
                <div class="portlet-body">
                    <?php foreach($getUser as $set): ?>
                        <form class="form-horizontal" role="form" method="post" action="<?php echo site_url('Groupuser/saveupdate') ?>">
                            <div class="form-body">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="panel panel-default">
                                            ...
                                            <div class="panel-body">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-lg-5">
                                                        <input type="hidden" class="form-control" id="GroupID" name="GroupID" value="<?php echo $set->GroupID?>">
                                                        <input type="text" class="form-control" id="GroupName" name="GroupName" value="<?php echo $set->GroupName ?>">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
