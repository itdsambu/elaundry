            ...
            <div class="portlet light bordered">
                ...
                <div class="portlet-body">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="btn-group pull-right">
                                    <a href="<?php echo site_url('Master_satuan/tambahData') ?>" class="btn green">
                    ...
                    <table class="table table-striped table-bordered table-hover table-header-fixed" id="table">
                        ...
                        <tbody>
                            <?php foreach($datasatuan as $get): ?>
                                <tr>
                                    <td><?php echo $get->nama_satuan?></td>
                                    ...
                                    <td class="text-center">
                                        <a href="<?php echo site_url('Master_satuan/editData')."/".$get->satuanID; ?>" class="btn btn-icon-only blue" title="Edit"><i class="fa fa-edit"></i></a>
                                        <a href="<?php echo site_url('Master_satuan/delete')."/".$get->satuanID; ?>" class="btn btn-icon-only red" title="Hapus" onClick="return confirm('Hapus <?php echo $get->nama_satuan;?> ?')"><i class="fa fa-trash"></i></a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
