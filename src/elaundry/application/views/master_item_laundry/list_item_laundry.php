            ...
            <div class="portlet light bordered">
                ...
                <div class="portlet-body">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="btn-group pull-right">
                                    <a href="<?php echo site_url('Master_item_laundry/tambah') ?>" class="btn green">
                    ...
                    <table class="table table-striped table-bordered table-hover table-header-fixed" id="table">
                        ...
                        <tbody>
                            <?php foreach ($listmasteritem as $get) : ?>
                                <tr>
                                    <td><?= $get->NamaItem ?></td>
                                    <td><?= $get->singkatan ?></td>
                                    <td><?= $get->NamaKategory ?></td>
                                    <td><?php if ($get->NotActive == 1) {
                                    ...
                                    <td><?php if ($get->LastUpdatedDate != NULL) {
                                            echo date('d M Y', strtotime($get->LastUpdatedDate));
                                        } ?></td>
                                    <td class="text-center">
                                        <a href="<?php echo site_url('Master_item_laundry/edit') . "/" . $get->Id_Item; ?>" class="btn btn-icon-only blue" title="Edit"><i class="fa fa-edit"></i></a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
