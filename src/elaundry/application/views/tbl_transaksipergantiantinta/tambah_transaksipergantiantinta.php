            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption font-dark">
                        ...
                        <span class="caption-subject bold uppercase">Tambah Transaksi Pergantian Tinta</span>
                    </div>
                    <div class="tools">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-4">
                                            <input type="date" name="tglpergantian" class="form-control" value="<?php echo $tglpergantian ?>">
                                        </div>
                                    </div>
                                </div>
                            </div>
