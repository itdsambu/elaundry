            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption font-dark">
                        ...
                        <span class="caption-subject bold uppercase"> Edit Item</span>
                    </div>
                    <div class="tools">
                ...
                <div class="portlet-body">
                    <form class="form-horizontal" role="form" method="post" action="<?php echo base_url('Master_Item/updateData')?>">
                        <div class="form-body">
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-4">
                                            <input type="text" name="txtkodeitem" id="kodeitem" class="form-control" readonly="" value="<?php echo $get->kode_item?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-lg-2 control-label">Nama Item</label>
                                        <div class="col-lg-4">
                                            <input type="text" name="txtNamaitem" id="namaitem" class="form-control" placeholder="Input Item" value="<?php echo $get->nama_item ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-4">
                                           <select class="form-control" name="txtKategori" id="kategori">
                                               ...
                                               <?php foreach($getDataKategori as $row){
                                                if($get->kategoriID == $row->kategoriID){?>
                                                    <option value="<?php echo $row->kategoriID?>" selected><?php echo $row->nama_kategori?></option>
                                                <?php }else{?>
