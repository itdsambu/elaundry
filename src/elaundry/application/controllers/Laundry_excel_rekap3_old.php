...
class Laundry_excel_rekap3 extends CI_Controller
{
  ...
  public function create_excel($post_thn_laporan)
  {
    ...
    for ($i3 = 0; $i3 < $jml_page2; $i3++) {
      ...
      $objPHPExcel->mergeCells('BU' . $start_row . ':BY' . $start_row)->setCellValue('BU' . $start_row, ': ' . 'RLPL/GAF/' . $thn_laporan);
        ...
        for ($i = 0; $i < 3; $i++) {
          ...
          if (isset($dtl_app2_by[((($i2 * 3) + $i) + ($i3 * 6))])) {
            if (trim($dtl_app2_by[((($i2 * 3) + $i) + ($i3 * 6))]) != '') {
              $ndt_app2_by[((($i2 * 3) + $i) + ($i3 * 6))] = $dtl_app2_by[((($i2 * 3) + $i) + ($i3 * 6))];
            } else {
          ...
          if (isset($dtl_app2_jabatan[((($i2 * 3) + $i) + ($i3 * 6))])) {
            if (trim($dtl_app2_jabatan[((($i2 * 3) + $i) + ($i3 * 6))]) != '') {
              $ndt_app2_jabatan[((($i2 * 3) + $i) + ($i3 * 6))] = $dtl_app2_jabatan[((($i2 * 3) + $i) + ($i3 * 6))];
            } else {
          ...
          if (isset($dtl_app3_by[((($i2 * 3) + $i) + ($i3 * 6))])) {
            if (trim($dtl_app3_by[((($i2 * 3) + $i) + ($i3 * 6))]) != '') {
              $ndt_app3_by[((($i2 * 3) + $i) + ($i3 * 6))] = 'REYNALD ALEX';
            } else {
              $ndt_app3_by[((($i2 * 3) + $i) + ($i3 * 6))] = '-';
            }
          } else {
            $ndt_app3_by[((($i2 * 3) + $i) + ($i3 * 6))] = '';
          }
          if (isset($dtl_app3_date[((($i2 * 3) + $i) + ($i3 * 6))])) {
            if (trim($dtl_app3_date[((($i2 * 3) + $i) + ($i3 * 6))]) != '') {
              $ndt_app3_date[((($i2 * 3) + $i) + ($i3 * 6))] = $dtl_app3_date[((($i2 * 3) + $i) + ($i3 * 6))];
            } else {
              $ndt_app3_date[((($i2 * 3) + $i) + ($i3 * 6))] = '-';
            }
          } else {
            $ndt_app3_date[((($i2 * 3) + $i) + ($i3 * 6))] = '';
          }
          if (isset($dtl_app3_comp[((($i2 * 3) + $i) + ($i3 * 6))])) {
            if (trim($dtl_app3_comp[((($i2 * 3) + $i) + ($i3 * 6))]) != '') {
              $ndt_app3_comp[((($i2 * 3) + $i) + ($i3 * 6))] = $dtl_app3_comp[((($i2 * 3) + $i) + ($i3 * 6))];
            } else {
              $ndt_app3_comp[((($i2 * 3) + $i) + ($i3 * 6))] = '-';
            }
          } else {
            $ndt_app3_by[((($i2 * 3) + $i) + ($i3 * 6))] = '';
          }
          if (isset($dtl_app3_status[((($i2 * 3) + $i) + ($i3 * 6))])) {
            if (trim($dtl_app3_status[((($i2 * 3) + $i) + ($i3 * 6))]) != '') {
              $ndt_app3_status[((($i2 * 3) + $i) + ($i3 * 6))] = $dtl_app3_status[((($i2 * 3) + $i) + ($i3 * 6))];
            } else {
              $ndt_app3_status[((($i2 * 3) + $i) + ($i3 * 6))] = '-';
            }
          } else {
            $ndt_app3_by[((($i2 * 3) + $i) + ($i3 * 6))] = '';
          }
          ...
          if (isset($dtl_app3_jabatan[((($i2 * 3) + $i) + ($i3 * 6))])) {
            if (trim($dtl_app3_jabatan[((($i2 * 3) + $i) + ($i3 * 6))]) != '') {
              $ndt_app3_jabatan[((($i2 * 3) + $i) + ($i3 * 6))] = 'General Manager';
            } else {
              $ndt_app3_jabatan[((($i2 * 3) + $i) + ($i3 * 6))] = '-';
            }
          } else {
            $ndt_app3_jabatan[((($i2 * 3) + $i) + ($i3 * 6))] = '';
          }
          ...
          $objPHPExcel->mergeCells($chr_o_x . (($i2 * $jml_row_perpage) + ($start_row + 12)) . ':' . $chr_v_x . (($i2 * $jml_row_perpage) + ($start_row + 12)))->setCellValue($chr_o_x . (($i2 * $jml_row_perpage) + ($start_row + 12)), "Disetujui Oleh");
            ...
            if ($dtl_app2_personalid[((($i2 * 3) + $i) + ($i3 * 6))] != '' && $dtl_app2_personalstatus[((($i2 * 3) + $i) + ($i3 * 6))] != '') {
                ...
                if ($dtl_app2_personalstatus[((($i2 * 3) + $i) + ($i3 * 6))] == 2) {
                    $base_path_app2 = 'assets/foto_kar/TTD_TK/' . $dtl_app2_personalid[((($i2 * 3) + $i) + ($i3 * 6))] . '.PNG';
                } else {
                    $base_path_app2 = 'assets/foto_kar/TTD_KRY/' . $dtl_app2_personalid[((($i2 * 3) + $i) + ($i3 * 6))] . '_0_0.PNG';
                }
                
                if (file_exists(FCPATH . '' . $base_path_app2)) {
                    $_img = new PHPExcel_Worksheet_Drawing();
                    $_img->setPath($base_path_app2);
                    $_img->setWidthAndHeight(170, 100);
                    $_img->setOffsetY(5);
          ...
          if ($dtl_app3_personalid[((($i2 * 3) + $i) + ($i3 * 6))] != '' && $dtl_app3_personalstatus[((($i2 * 3) + $i) + ($i3 * 6))] != '') {
          ...
          $objPHPExcel->mergeCells($chr_i_x . (($i2 * $jml_row_perpage) + ($start_row + 15)) . ':' . $chr_n_x . (($i2 * $jml_row_perpage) + ($start_row + 15)))->setCellValue($chr_i_x . (($i2 * $jml_row_perpage) + ($start_row + 15)), ": " . $ndt_app2_by[((($i2 * 3) + $i) + ($i3 * 6))]);
          ...
          $objPHPExcel->mergeCells($chr_q_x . (($i2 * $jml_row_perpage) + ($start_row + 15)) . ':' . $chr_v_x . (($i2 * $jml_row_perpage) + ($start_row + 15)))->setCellValue($chr_q_x . (($i2 * $jml_row_perpage) + ($start_row + 15)), ": " . $ndt_app3_by[((($i2 * 3) + $i) + ($i3 * 6))]);
          ...
          $objPHPExcel->mergeCells($chr_i_x . (($i2 * $jml_row_perpage) + ($start_row + 16)) . ':' . $chr_n_x . (($i2 * $jml_row_perpage) + ($start_row + 16)))->setCellValue($chr_i_x . (($i2 * $jml_row_perpage) + ($start_row + 16)), ": " . $ndt_app2_jabatan[((($i2 * 3) + $i) + ($i3 * 6))]);
          ...
          $objPHPExcel->mergeCells($chr_q_x . (($i2 * $jml_row_perpage) + ($start_row + 16)) . ':' . $chr_v_x . (($i2 * $jml_row_perpage) + ($start_row + 16)))->setCellValue($chr_q_x . (($i2 * $jml_row_perpage) + ($start_row + 16)), ": " . $ndt_app3_jabatan[((($i2 * 3) + $i) + ($i3 * 6))]);
          ...
          $objPHPExcel->mergeCells($chr_i_x . (($i2 * $jml_row_perpage) + ($start_row + 17)) . ':' . $chr_n_x . (($i2 * $jml_row_perpage) + ($start_row + 17)))->setCellValue($chr_i_x . (($i2 * $jml_row_perpage) + ($start_row + 17)), ": " . $ndt_app2_date[((($i2 * 3) + $i) + ($i3 * 6))]);
          ...
          $objPHPExcel->mergeCells($chr_q_x . (($i2 * $jml_row_perpage) + ($start_row + 17)) . ':' . $chr_v_x . (($i2 * $jml_row_perpage) + ($start_row + 17)))->setCellValue($chr_q_x . (($i2 * $jml_row_perpage) + ($start_row + 17)), ": " . $ndt_app3_date[((($i2 * 3) + $i) + ($i3 * 6))]);
